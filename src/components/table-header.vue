    ...
    <div class="head__NLQw"
      ...
      <div class="row__29JV"
        ...
        <div class="cell__3xqP resizable__3OIa"
          ...
          <div class="suffix__1j4D"
               @click="onAllRowOpen"
               aria-haspopup="true"
               aria-expanded="false">
            <i :class="collapsed ? 'next-icon-chevrons-expand-vertical' : 'next-icon-chevrons-collapsed-vertical'"
        ...
        <div class="cell__3xqP resizable__3OIa"
          ...
          <div class="head-cell__cL1U">
            <span class="ellipsis__315v sortable___z3_">负责人</span>
          </div>
          <div class="handle__cGEN right"
               data-role="handle"
               @mousedown="(event) => dispatchGesture('mouseDown', event)"
        ...
        <div class="cell__3xqP resizable__3OIa"
          ...
          <div class="head-cell__cL1U">
            <span class="ellipsis__315v sortable___z3_">
              截止时间
              <i class="next-icon next-icon-triangle-up-s next-medium">
                <svg viewBox="0 0 1024 1024">
