<template>
  <div class="menu-trigger__2YZ4"
       ...
       @keydown.enter="() => {}">
    <a-dropdown ref="dropdown"
                v-model="visible"
                :trigger="['click']"
                :overlayStyle="{ 'z-index': 1300 }">
      <span class="icon__YImk icon dls-icon icon-more"
            data-role="icon"></span>
      <MenuWrap slot="overlay">
        <div v-if="visible"
             class="dropdown__u1N0 slide-enter-done"
             data-role="popup"
          ...
          <div class="dropdown-container__1UDy">
            <div class="popup-menu__3OeO popup__2xg9">
              <div class="popup-menu-header__1u4j popup-head__291F">
                ...
                <div>
                  <span @click="close"
                        class="icon__YImk icon dls-icon icon-remove popup-menu-close__102T"
                        data-role="icon"></span>
                </div>
              </div>
              <div class="separator-full__2UhN"
                   data-role="separator">

              </div>
              <div class="popup-menu-view__fI0k popup-body__37yU">
                <ul v-if="!isDelete"
                    class="menu__21sM main-view__KEvn"
                    data-role="menu">
                  <li class="menu-item__dkeQ"
                      data-role="menu-item">
                    <span class="text">点击进入任务详情</span>
                  </li>
                  <li v-if="barInfo._index > 0"
                      @click="moveRightTask"
                  ...
                  <li class="separator__3vM5"
                      data-role="separator"></li>
                  <a class="popup-menu-link__wpP-">
                    <li @click="deleteTask"
                        class="menu-item__dkeQ danger__2yG_"
                        data-role="menu-item">
