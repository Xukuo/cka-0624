<template>
  <button @click="timeTranslateLocation"
  ...
  ">
    <span v-if="type === 'left'"
          class="icon__YImk icon dls-icon icon-circle-arrow-left-o"
          data-role="icon"></span>
    <span>今天</span>
    <span v-if="type === 'right'"
          class="icon__YImk icon dls-icon icon-circle-arrow-right-o"
          data-role="icon"></span>
  </button>
</template>
<script>
